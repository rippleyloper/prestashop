...
{block name='content'}
   ...
   ">
                    {/if}
                    <span class="bg-danger btn btn-danger" style="position: absolute;z-index: 2"> {round(((($product.price_tax_exc*100)/$product.price_without_reduction)-100)*-1 ,0)}% DCTO </span>
            ...
            <div class="col-md-6 product-content">
                    ...
                    {block name='page_header'}
                        ...
                        {if isset($manufacturer_image_url)}
                            <a href="{$product_brand_url}">
                                <img src="{$manufacturer_image_url}" style="max-width: 100px" class="img img-responsive manufacturer-logo" />
                            </a>
                ...
                <div class="product-information">
                    <div class="product-reference">
                        ...
                        <span itemprop="sku">{$product.quantity}</span>
                    </div>
                    <div class="product-reference">
