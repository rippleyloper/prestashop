...
<section class="special-products">
	...
	<h2 class="h1 products-section-title text-uppercase">
		{l s='Specials products' d='Shop.Theme.Global'}
		<span class="title_product">INVERSIERRA HOGAR™, Catálogo De Productos On Line Temporada {{date('Y')}}.</span>
	</h2>
	<div id="spe_res">
	<div class="products">
		...
		{if $slider == 0}
			<li class="loadmore">
				<a class="btn btn-default" href="productos-rebajados">Ver Mas</a>
