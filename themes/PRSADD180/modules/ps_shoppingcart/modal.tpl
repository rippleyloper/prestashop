        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="cart-content">
              ...
              {/if}
              <p><strong>{l s='Total:' d='Shop.Theme.Checkout'}</strong>&nbsp;{*$cart.totals.total.value*} {$cart.subtotals.products.value }{$cart.labels.tax_short}</p>
              <button type="button" class="btn btn-secondary btn-primary" data-dismiss="modal">{l s='Continue shopping' d='Shop.Theme.Actions'}</button>
