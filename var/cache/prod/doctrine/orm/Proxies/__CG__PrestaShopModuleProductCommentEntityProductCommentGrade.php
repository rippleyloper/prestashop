...
class ProductCommentGrade extends \PrestaShop\Module\ProductComment\Entity\ProductCommentGrade implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PrestaShop\\Module\\ProductComment\\Entity\\ProductCommentGrade' . "\0" . 'comment', '' . "\0" . 'PrestaShop\\Module\\ProductComment\\Entity\\ProductCommentGrade' . "\0" . 'criterion', '' . "\0" . 'PrestaShop\\Module\\ProductComment\\Entity\\ProductCommentGrade' . "\0" . 'grade');
        }
    ...
    public function getCriterion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCriterion', array());
