...
class ProductCommentReport extends \PrestaShop\Module\ProductComment\Entity\ProductCommentReport implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PrestaShop\\Module\\ProductComment\\Entity\\ProductCommentReport' . "\0" . 'comment', '' . "\0" . 'PrestaShop\\Module\\ProductComment\\Entity\\ProductCommentReport' . "\0" . 'customerId');
        }
