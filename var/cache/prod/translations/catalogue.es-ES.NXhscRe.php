...
$catalogue = new MessageCatalogue('es-ES', array (
  ...
  'ShopFormsLabels' => 
  array (
    'enter email address here ...' => 'Ingrese su email ....',
    'VAT number' => 'RUT',
    'State' => 'Comuna',
  ...
  array (
    ...
    'Specials products' => 'Productos en Oferta.',
    'Top products' => 'Nuestros Productos.',
    'All new products' => 'Más Productos',
    'New Products' => 'Productos',
    '(tax incl.)' => '.',
    '(tax excl.)' => '.',
    '(tax included)' => '.',
    '(tax excluded)' => '.',
    'Tax included' => '.',
    'Tax excluded' => '.',
    'reload more' => 'Cargar más',
    'Sign Up For Newsletter' => 'Suscríbete',
    '%copyright% %year% - Ecommerce software by %prestashop%' => ' Inversierra S.A. - %copyright% %year% ',
    ...
    '[1]%phone%[/1]' => '[1]%phone%[/1]',
    '[1]%email%[/1]' => '[1]%email%[/1]',
    'Call us:</span> [1]%phone%[/1]' => 'Call us:</span> [1]%phone%[/1]',
    'Fax:</span> [1]%fax%[/1]' => 'Fax:</span> [1]%fax%[/1]',
    'Email us:</span> [1]%email%[/1]' => 'Email us:</span> [1]%email%[/1]',
    'Wants to get latest updates! sign up for free.' => 'Wants to get latest updates! sign up for free.',
    'blog' => 'blog',
    'Trending Products' => 'Trending Products',
  ),
  'AdminOrderscustomersFeature' => 
  array (
    'Card Expiration' => 'Código Autorización',
...
Saludos',
  ...
  array (
    'Fast and easy checkout' => 'Pagar  rápido y sencillo',
  ...
  'ShopThemeCheckout' => 
  array (
    'Order with an obligation to pay' => 'Pagar',
    'Have a promo code?' => 'Agregar un código descuento.',
    'Promo code' => 'Código promoción',
    'Total shipping:' => 'Envío :',
    'Cart' => 'Carro',
    'Shopping Cart' => 'Carro',
    'Product Successfully Added to Your Shopping Cart' => 'Producto añadido correctamente a su carro de compra',
    'There are %products_count% items in your cart.' => 'Hay %products_count% artículos en su carro.',
    'There is %product_count% item in your cart.' => 'Hay %product_count% artículo en su carro.',
    'There are no more items in your cart' => 'No hay más artículos en su carro',
    '%product_count% item in your cart' => '%product_count% artículo en su carro',
    '%products_count% items in your cart' => '%products_count% artículos en su carro',
    'If you sign out now, your cart will be emptied.' => 'Si cierra sesión ahora, se vaciará su carro.',
    'Shipping' => 'Envio',
    'Order as a guest' => 'Compra sin Registro',
    'Product successfully added to your shopping cart' => 'Producto añadido correctamente a su carro de compra',
    'Check out' => 'Continuar',
    'Total products' => 'Toltal Productos',
    'No products in the cart.' => 'No hay productos en el carro',
  ...
  array (
    ...
    'List of products by brand %s' => ' %s',
    'List of products by supplier %s' => ' %s',
  ...
  'messages' => 
  array (
    'Show carts and orders for this customer.' => 'Mostrar los carros y pedidos de este cliente.',
    'Hide carts and orders for this customer.' => 'Ocultar los carros y pedidos de este cliente.',
    'Carts' => 'Carro',
    'Cart ID' => 'ID carro',
  ...
  array (
    ...
    'Adds a block containing the customer\'s shopping cart.' => 'Añade un bloque que contiene el carro de compra del cliente.',
  ...
  array (
    'Cart is empty' => 'El carro está vacío',
  ...
  'ShopTemeheckout' => 
  array (
    'Process To CheckOut' => 'Proceso a CheckOut',
  ),
  'ar-SA' => 
  array (
    'Contact us' => 'اتصل بنا',
