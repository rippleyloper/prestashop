...
{foreach from=$node item=Item name=myLoop}
	<li>
		<p class="catblog_p">
			...
			<a class="catblog_desc" href="{PrestaBlogUrl c=$Item.id_prestablog_categorie titre=$Item.link_rewrite}" class="link_block"><br /><span>{$Item.description_crop|escape:'htmlall':'UTF-8'}</span></a>{/if}
		</p>
