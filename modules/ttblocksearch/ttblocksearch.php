...
class TtBlockSearch extends Module implements WidgetInterface
{
    private $html;
    public function __construct()
    {
        $this->name = 'ttblocksearch';
        ...
        $this->bootstrap = true;
        parent::__construct();
        $this->displayName = $this->getTranslator()->trans('TT - Ajax Category Search', array(), 'Modules.TTblocksearch.Admin');
        $this->description = $this->getTranslator()->trans('Show a quick search category to your website..', array(), 'Modules.TTblocksearch.Admin');
    ...
    public function hookHeader($params)
    {
        ...
        $this->context->controller->addJS($this->_path.'views/js/ttblocksearch.js');
        $this->context->controller->addCSS(_THEME_CSS_DIR_.'product_list.css');
        $this->context->controller->addCSS(($this->_path).'views/css/ttsearch.css', 'all');
        if (Configuration::get('PS_SEARCH_AJAX')) {
    ...
    {
         return $this->display(__FILE__, 'ttblocksearch-nav.tpl');
    }
    ...
    public function renderWidget($hookName, array $configuration)
    {
        ...
        return $this->fetch('module:'.$this->name.'/views/templates/hook/ttblocksearch-top.tpl', $this->getCacheId());
    }
    ...
    public function LiveSearchProduct($id_cat, $id_lang, $expr, $page_number = 1, $page_size = 1, $order_by = 'position', $order_way = 'asc', $ajax = false, Context $context = null)
    {
        if ($id_cat == 'all') {
            $id_cat = 0;
        }
