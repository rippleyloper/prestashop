...
class TtBlockSearchCateSearchModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function assign()
    {
        ...
        if (Tools::getValue('instantSearch') && !is_array($query)) {
            ...
            $this->context->smarty->assign(array(
                ...
                'request'=>$this->context->link->getModuleLink('ttblocksearch', 'catesearch'),
            ...
            if ($id_category == 'all') {
                ...
                foreach ($search['result'] as $product) {
                    ...
                    if (in_array((int)$id_category, $categories_id)) {
                        if (($this->p - 1) * $this->n <= $index && $index < $this->p * $this->n) {
                            $results[] = $product;
                        }
                        $index++;
