                        ...
                        <div class="module-item-wrapper-grid">
                            ...
                            <div class="module-quick-description-grid no-padding mb-0">
                                ...
                                <div class="module-read-more-grid">
                                    <a href="https://hipresta.com/module/hiprestashopapi/prestashopapi?secure_key=6db77b878f95ee7cb56d970e4f52f095&redirect=1&module_key={$k}" target="_blank">{l s='Read more' mod='hipopupnotification'}</a>
                                </div>
                            </div>
                            <div class="module-container module-quick-action-grid clearfix">
                                <div class="badges-container">
                                    <div>
                                        ...
                                        <span>{l s='Made by HiPresta' mod='hipopupnotification'}</span></div>
                                    </div>
                                <hr>
                                ...
                                <div class="form-action-button-container">
                                    ...
                                    {l s='Discover' mod='hipopupnotification'}</a>
                                </div>
                            </div>
                        </div>
                    </div>
