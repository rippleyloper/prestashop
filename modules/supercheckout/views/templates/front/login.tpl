        ...
        {if $settings['fb_login']['enable'] eq 1 || $settings['google_login']['enable'] eq 1 || $settings['paypal_login']['enable'] eq 1}
            <div class="social-login">
                ...
                {if $settings['google_login']['enable'] eq 1}
                    ...
                    {else}
                        <a href="{$supercheckout_url}&myGoogleLogin" class="googleButton btn azm-social azm-btn azm-pill azm-google-plus" ><i class="fab fa-google"></i> Google</a>
                    {/if}
                {/if}
                {if $settings['paypal_login']['enable'] eq 1}
                    ...
                    {else}
                        <a href="{$supercheckout_url}&myPaypalLogin" class="btn azm-social azm-btn azm-border-bottom azm-paypal" style="color: #ffffff; background: #009cde;"><i class="fa fa-paypal"></i>Login with Paypal</a>
                    {/if}
                {/if}
